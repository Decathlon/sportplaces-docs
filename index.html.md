...
A filter is associated to a sport place's activity. As opposed to tags that are boolean, their value ranges either as a numerical value or an array of values. 

_Ex: How long is this kayaking track?_ Becomes
What is the value of the `distance` **filter**?

## List of available filters

Each filter has to be linked to a sport before being associated to a sport place's activity. Here's the full list of available filters.
